...
(function () {
  ...
  onReady(function () {
    ...
    // Initialize user profile values in UI if window.adminHMDUser is provided.
    function initUserProfile() {
      if (!window.adminHMDUser) return;
      ...
      if (sidebarAvatar && user.avatar) { sidebarAvatar.src = user.avatar; sidebarAvatar.alt = user.name || "User"; }
