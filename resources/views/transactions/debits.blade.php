<x-app-layout>
    <x-slot name="header">
        <div class="page-heading-copy">
            <span class="page-icon text-danger" style="background: rgba(220, 38, 38, 0.12); color: #dc2626;">
                <i class="bi bi-arrow-up-right-circle-fill" aria-hidden="true"></i>
            </span>
            <div>
                <p class="eyebrow mb-1 text-danger">Payables</p>
                <h1 class="h3 mb-0">Debits (I Owe Others)</h1>
            </div>
        </div>
        <div class="heading-actions">
            <a href="{{ route('transactions.create') }}" class="btn btn-primary">
                <i class="bi bi-plus-lg me-1"></i> Add Debit Record
            </a>
        ...
        <div class="col-12 col-md-6 col-lg-4">
            <div class="metric-card metric-danger h-100">
                <div class="metric-top">
                    <span class="metric-label">Active Payables</span>
                ...
                <div class="metric-meta">
                    <span>Total pending debt you owe others</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="panel mb-4">
        <form method="GET" action="{{ route('transactions.debits') }}" class="row g-2 align-items-center">
            <div class="col-12 col-md-9">
                <div class="input-group">
                    ...
                    <input type="search" 
                           ...
                           placeholder="Search debit records by title or person...">
                </div>
            </div>
            <div class="col-12 col-md-3 d-flex gap-2">
                ...
                @if (request()->filled('search'))
                    <a href="{{ route('transactions.debits') }}" class="btn btn-outline-secondary" title="Reset filter">
        ...
        <div class="panel-header">
            <div>
                <h2 class="h5 mb-1 section-title">
                    <i class="bi bi-arrow-up-right-circle text-danger" aria-hidden="true"></i>
                    <span>Debit Records</span>
                </h2>
                <p class="text-muted small mb-0">All debts and money that you owe to others.</p>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center gap-2">
                                    <div class="avatar-sm rounded-circle d-inline-grid place-items-center bg-light border fw-bold text-danger" style="width: 28px; height: 28px; font-size: 0.75rem;">
                                        {{ strtoupper(substr($transaction->person_name, 0, 1)) }}
                                    </div>
                                    <span>{{ $transaction->person_name }}</span>
                                </div>
                            </td>
                            <td class="text-danger fw-bold fs-6">-Rs. {{ number_format($transaction->amount, 2) }}</td>
                            <td>
                        ...
                        <tr>
                            <td colspan="6" class="text-center py-5">
                                <div class="blank-state mx-auto">
                                    ...
                                    <h5 class="fw-bold mb-1">No Debit Records Found</h5>
                                    <p class="text-muted small mb-3">You do not have any debit records listed.</p>
                                    <a href="{{ route('transactions.create') }}" class="btn btn-primary btn-sm">
                                        <i class="bi bi-plus-lg me-1"></i> Add New Debit
                                    </a>
                                </div>
                            </td>
                        </tr>
